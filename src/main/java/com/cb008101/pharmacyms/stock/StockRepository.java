...
public interface StockRepository extends CrudRepository<Stock, Integer> {
    ...
    @Query(value = "SELECT new com.cb008101.pharmacyms.dto.StockItemDTO(s.stockID, d.phItemID, d.itemName, s.mfDate, s.expDate, s.qty, s.rcvdDate, d.itmPrice) FROM Stock s" +
