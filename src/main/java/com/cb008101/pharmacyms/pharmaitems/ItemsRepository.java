...
public interface ItemsRepository extends CrudRepository<Items, Integer> {
    @Query(value = "SELECT new com.cb008101.pharmacyms.dto.ItemDTO(d.phItemID, d.itemName, b.brandID, b.brandName, c.categoryID , c.categoryName, d.itemQuantity, d.itmPrice) FROM Items d " +
